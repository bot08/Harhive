...
/* Указываем страницу */
$navpage="403";  /* Для выделения навигации */
$pagetitle="403";   /* Текст в название страницы */
...
<head>
    ...
    <?php if ($darkmode=="true")  echo "<link href=\"https://harhive.pp.ua/dist/css/dark.css\" rel=\"stylesheet\">";?>
</head>
<style>
...
<main class="container">
 <center>
   <h1 class="display-4"><b>Нет доступа :/</b></h1>
   <h4>403</h4>
