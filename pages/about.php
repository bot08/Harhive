<h1 class="display-4"><b>О сайте</b></h1>
 ...
 <p><br>Сверху скриншот первой рабочей версии - 0.42. Отображались картинки тогда на весь экран и загружалось сразу 72 штуки, в большом разрешении. Но с каждым новым обновлением он становился лучше. В версии 0.8 он был переписан на php. Есть все копии от версии 0.2 до 1.0 (включая беты), так что если хотите посмотреть напишите на почту <b><a class="<?php if($darkmode=="true"){echo "text-light";} else{echo "text-dark";}?>" href="mailto:info.harhive@gmail.com">info.harhive@gmail.com</a></b>.   </p>
...
Также мы перешли на собственные сервера с картинками ну и изменился подход с загрузкой картинок (перешли на симбиоз js и php). Теперь у нас есть миниатюры картинок и сами картинки, также это повлияло на скорость подгрузки и восприятия сайта. <br> </p>
...
<main class="container">
  ...
  <a href="https://old.harhive.pp.ua/" type="button" class="btn shadow p-2 mb-4 button <?php if ($darkmode=="true"){echo "btn-danger";} else{echo "btn-light";} ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-up-right" viewBox="0 0 16 16"> <path fill-rule="evenodd" d="M6.364 13.5a.5.5 0 0 0 .5.5H13.5a1.5 1.5 0 0 0 1.5-1.5v-10A1.5 1.5 0 0 0 13.5 1h-10A1.5 1.5 0 0 0 2 2.5v6.636a.5.5 0 1 0 1 0V2.5a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v10a.5.5 0 0 1-.5.5H6.864a.5.5 0 0 0-.5.5z"/> <path fill-rule="evenodd" d="M11 5.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793l-8.147 8.146a.5.5 0 0 0 .708.708L10 6.707V10.5a.5.5 0 0 0 1 0v-5z"/> </svg> OLD Harhive</a>
