...
<HTML lang="ru">
  <head>
    ...
    <meta name="description" content="Новый сайт Harhive - невероятно большой архив заставок! 100000+ картинок!">
    <meta name="author" content="Harhive">
    <title>Harhive</title>
    <?php $thisPage="wallpaper"; ?>
...
<main class="container"> 
  <script src = 'js_json/urls.json' type="text/javascript"></script> 
  ...
  <script src="js_json/img.js?2"></script>
...
<div class="container">
  <div id="war"><br> </p><div class="alert alert-warning shadow p-3 mb-5" role="alert">Все проблемы описаны в разделе "Ответы на вопросы"</div></div>
