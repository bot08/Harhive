...
for(i=0;i<12;i++){
    ...
    bot.innerHTML = '<button onclick="out()" type="button" class="btn btn-light shadow p-2 mb-4 button">Загрузить ещё</button><a href="https://harhive.pp.ua/wallpaper" type="button" class="btn btn-light  shadow p-2 mb-4 button">Перезагрузить страницу</a>'; //Добавляем кнопки //Убираем прогрузить
}
